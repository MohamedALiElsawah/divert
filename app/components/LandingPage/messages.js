...
export default defineMessages({
  ...
  agentLogin: {
    id: `${scope}.header.agentLogin`,
    defaultMessage: 'LOGIN AS AGENT',
  },
  clientLogin: {
    id: `${scope}.header.clientLogin`,
    defaultMessage: 'LOGIN AS CLIENT',
  },
  brand: {
    id: `${scope}.header.brand`,
    defaultMessage: 'Divert',
  },
