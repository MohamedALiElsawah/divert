...
export default defineMessages({
  registerFieldEnName: {
    id: `${scope}.Register.field.enName`,
    defaultMessage: 'English Name',
  },
  registerFieldArName: {
    id: `${scope}.Register.field.arName`,
    defaultMessage: 'Arabic Name',
  },
  registerFieldEmail: {
    id: `${scope}.Register.field.email`,
  ...
  registerFieldRef: {
    id: `${scope}.Register.field.ref`,
    defaultMessage: 'Reference Id',
  },
  registerFieldvehicleNumber: {
    id: `${scope}.Register.field.VehcNum`,
    defaultMessage: 'Vehicle Number',
  },
  registerFieldWorkingHours: {
    id: `${scope}.Register.field.workhours`,
    defaultMessage: 'Working Hours',
  },
  registerFieldComission: {
    id: `${scope}.Register.field.comission`,
    defaultMessage: 'Comission',
  },
  registerFieldSim: {
    id: `${scope}.Register.field.sim`,
    defaultMessage: 'Sim Number',
  },
  registerFieldpassword: {
    id: `${scope}.Register.field.password`,
    defaultMessage: 'Password',
  },
  registerFieldActive: {
    id: `${scope}.Register.field.active`,
