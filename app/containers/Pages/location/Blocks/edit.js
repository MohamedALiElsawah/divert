...
import { editBlockApi, getBlockDetailsApi } from '../apis'
...
function EditForm(props) {
  ...
  useEffect(() => {
    ...
    getBlockDetailsApi(id).then(res => {
      // (res.data.data)
  ...
  const onSubmit = (valueForm) => {
    ...
    setLoading(true)
    editBlockApi(id, obj).then(res => {
      setLoading(false)
      handleSuccessMessage('Block Updated successfully!')
    })
      .catch(error => {
        setLoading(false)
