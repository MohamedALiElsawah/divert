...
import { editAreaApi, getAreaDetailsApi } from '../apis'
...
function EditForm(props) {
  ...
  const onSubmit = (valueForm) => {
    ...
    setLoading(true)
    editAreaApi(id, obj).then(res => {
      setLoading(false)
      handleSuccessMessage('Area Updated successfully!')
    })
      .catch(error => {
        setLoading(false)
...
const mapStateToProps = state => ({
  ...
  governoratesLookups: state.get(lookupsReducer).governorates,
