...
import { storeAreas, setLoading } from '../actions';
import { getAreasApis, deleteAreaApi } from '../apis';
                ...
                <TableCell align="left">
                  ...
                  <Fab
                    ...
                    onClick={() => {
                      ...
                      history.push(`/app/area/${item.id}/edit`);
                    }}
                  >
                    <EditIcon />
                  </Fab>
...
const mapStateToProps = state => ({
  ...
  areas: state.get(reducer).areas,
  ...state,
});

const ClientListMapped = connect(
  mapStateToProps,
  { storeAreas, setLoading }
)(ClientList);
