...
import { createClientApi } from '../apis';
...
function RegisterForm(props) {
  ...
  const onSubmit = (valueForm) => {
    ...
    setLoading(true);
    createClientApi(obj).then(res => {
      setLoading(false);
      handleSuccessMessage(intl.formatMessage(messages.clientCreated));
      reset();
    })
      .catch(error => {
        setLoading(false);
    ...
    <Paper className={classes.sideWrap}>
      ...
      <section>
        <ValidatorForm
          onSubmit={onSubmit}
          onError={errors => {
            console.log('error goes here', errors);
          }}
        >
