...
import { setLoading, setError, setUserData } from './authActions';
import { loginAgentApi } from './authApis';


function Login({
  classes, setLoading, setError, setUserData
}) {
    ...
    <div className={classes.rootFull}>
      ...
      <div className={classes.containerSide}>
        ...
        <div className={classes.sideFormWrap}>
          <LoginForm onSubmit={(values) => submitForm(values)} type="Agent" />
        </div>
      </div>
    </div>
  );
