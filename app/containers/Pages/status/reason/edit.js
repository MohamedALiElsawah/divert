...
import { editReasonApis, getReasonDetailsApis } from '../apis'
...
function EditForm(props) {
  ...
  useEffect(() => {
    ...
    getReasonDetailsApis(id).then(res => {
      // (res.data.data)
  ...
  const onSubmit = (valueForm) => {
    ...
    setLoading(true)
    editReasonApis(id, obj).then(res => {
      setLoading(false)
         ...
         <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                    ...
                    <MenuItem value={'R'}>Returned</MenuItem>
...
const mapStateToProps = state => ({
  ...
  areasLookups: state.get(lookupsReducer).areas,
