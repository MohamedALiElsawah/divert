...
function ClientList(props) {
  ...
  const changeStatus = () => {
    ...
    changeOrderStatusApi(obj).then(res => {
      handleSuccessMessage(<FormattedMessage {...messages.statusChangedMsg} />);
      getOrderDetails(id);
      handleClose();
    });
  };
  ...
  const assignDriver = () => {
    ...
    AssignDriverApi(obj).then(res => {
      handleSuccessMessage(<FormattedMessage {...messages.driverChangedMsg} />);
      getOrderDetails(id);
      handleClose();
    });
  };
  ...
  return (
    <Fragment>
      <div className={classes.rootTable}>
        <Grid container>
          ...
          <Grid item xs={6} sm={8}>
            <Grid container>
              {/* order data */}
              <Grid item xs={12} sm={12}>
                <PapperBlock title={<FormattedMessage {...messages.orderData} />} whiteBg desc="">
                  <Grid container className={classes.colList}>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.orderNum} />} secondary={orderDetails.order_nubmer} />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.qr} />} secondary={orderDetails.qr} />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.refNum} />} secondary={orderDetails.reference_number} />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText
                          primary={<FormattedMessage {...messages.type} />}
                          secondary={
                            orderDetails.is_immediate ? <FormattedMessage {...messages.immediatly} /> : <FormattedMessage {...messages.scheduled} />}
                        />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText
                          primary={<FormattedMessage {...messages.paymentMethod} />}
                          secondary={
                            orderDetails.payment_method == 'Cash' ? <FormattedMessage {...messages.cash} /> : <FormattedMessage {...messages.credit} />}
                        />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.pickupDate} />} secondary={orderDetails.pickup_date} />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.pickupTime} />} secondary={orderDetails.pickup_time} />
                      </ListItem>
                    </Grid>
                    ...
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.quantity} />} secondary={orderDetails.quantity} />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.weight} />} secondary={orderDetails.weight} />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.notes} />} secondary={orderDetails.notes} />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.status} />} secondary={orderDetails.status && orderDetails.status.name_en} />
                      </ListItem>
                    </Grid>
                    <Grid item md={4}>
              ...
              <Grid item xs={12} sm={12}>
                ...
                <PapperBlock icon="electric_bike" title={<FormattedMessage {...messages.driverData} />} whiteBg desc="">
                  <Grid container className={classes.colList}>
                    <Grid item md={6}>
                      <ListItem>
                        <ListItemAvatar>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.name} />} secondary={(orderDetails.driver && orderDetails.driver.name_en)?orderDetails.driver.name_en:'Not assigned yet'} />
                      </ListItem>
                    </Grid>
              ...
              {/* receiver data */}
              <Grid item xs={12} sm={12}>
                <PapperBlock icon="call_received" title={<FormattedMessage {...messages.receiverData} />} whiteBg desc="">
                  <Grid container className={classes.colList}>
                    <Grid item md={6}>
                      <ListItem>
                        <ListItemAvatar>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.name} />} secondary={orderDetails.receiver_name} />
                      </ListItem>
                    </Grid>
                    <Grid item md={6}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.phone} />} secondary={orderDetails.receiver_phone} />
                      </ListItem>
                    </Grid>
                    <Grid item md={12}>
                      <ListItem>
                        ...
                        <ListItemText
                          primary={<FormattedMessage {...messages.address} />}
                          secondary={
              ...
              {/* sender data */}
              <Grid item xs={12} sm={12}>
                <PapperBlock icon="send" title={<FormattedMessage {...messages.senderData} />} whiteBg desc="">
                  <Grid container className={classes.colList}>
                    <Grid item md={6}>
                      <ListItem>
                        <ListItemAvatar>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.name} />} secondary={orderDetails.client && orderDetails.client.name_en} />
                      </ListItem>
                    </Grid>
                    <Grid item md={6}>
                      <ListItem>
                        ...
                        <ListItemText primary={<FormattedMessage {...messages.branch} />} secondary={orderDetails.branch && orderDetails.branch.name} />
                      </ListItem>
                    </Grid>
                    <Grid item md={12}>
                      <ListItem>
          ...
          <Grid item xs={6} sm={4}>
            <PapperBlock whiteBg noMargin title={<FormattedMessage {...messages.history} />} icon="av_timer" desc="">
        ...
        >
          <DialogTitle id="alert-dialog-slide-title"><FormattedMessage {...messages.changeStatus} /></DialogTitle>
          <DialogContent>
            <Grid container>
              <Grid item xs={12} sm={4}>
                <p><FormattedMessage {...messages.selectStatus} /></p>
              ...
              <Grid item xs={12} sm={4}>
                <p><FormattedMessage {...messages.selectSubReason} /></p>
                <FormControl component="fieldset" className={classes.formControl}>
        ...
        <Dialog
          ...
          aria-describedby="alert-dialog-slide-description"
        >
          <DialogTitle id="alert-dialog-slide-title"><FormattedMessage {...messages.assignDriver} /></DialogTitle>
          <DialogContent>
            <ValidatorForm
              // onSubmit={onSubmit}
              ...
              <Grid container>
                <Grid item xs={12} sm={6}>
                  <TextValidator
                    ...
                    label={<FormattedMessage {...messages.driver} />}
